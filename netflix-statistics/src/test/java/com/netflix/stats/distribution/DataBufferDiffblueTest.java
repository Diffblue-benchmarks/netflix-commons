...
public class DataBufferDiffblueTest {
   ...
   * <ul>
   *   <li>Then {@link DataBuffer#DataBuffer(int)} with capacity is one SampleSize is one.</li>
   * </ul>
   * <p>
   ...
   * Test {@link DataBuffer#noteValue(double)}.
   * <ul>
   *   <li>Then {@link DataBuffer#DataBuffer(int)} with capacity is three SampleSize is one.</li>
   * </ul>
   * <p>
   * Method under test: {@link DataBuffer#noteValue(double)}
   */
