...
public class HistogramDiffblueTest {
   ...
   * <ul>
   *   <li>Then {@link Histogram#Histogram(double, double, double)} with min is ten and max is ten and step is ten Maximum is {@link Double#MAX_VALUE}.</li>
   * </ul>
   * <p>
   ...
   * Test {@link Histogram#noteValue(double)}.
   * <ul>
   *   <li>Then {@link Histogram#Histogram(double, double, double)} with min is ten and max is ten and step is ten Maximum is ten.</li>
   * </ul>
   * <p>
   * Method under test: {@link Histogram#noteValue(double)}
   */
