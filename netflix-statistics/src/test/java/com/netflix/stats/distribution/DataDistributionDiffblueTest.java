...
public class DataDistributionDiffblueTest {
   ...
   */
  @Test
  public void testNewDataDistribution() {
    // Arrange
    double[] percents = new double[]{10.0d, 1.0d, 10.0d, 1.0d};

    // Act
    DataDistribution actualDataDistribution = new DataDistribution(3, percents);
    ...
    assertSame(percents, actualDataDistribution.getPercents());
