...
public class DataDistributionDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "double DataDistribution.getMaximum()",
    "double DataDistribution.getMean()",
    "double DataDistribution.getMinimum()",
    "long DataDistribution.getNumValues()",
    "double[] DataDistribution.getPercentiles()",
    "double[] DataDistribution.getPercents()",
    "long DataDistribution.getSampleIntervalMillis()",
    "int DataDistribution.getSampleSize()",
    "double DataDistribution.getStdDev()",
    "long DataDistribution.getTimestampMillis()",
