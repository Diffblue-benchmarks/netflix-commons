...
public class SyncSubscribersGatekeeperDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link SyncSubscribersGatekeeper#isSyncSubscriber(SubscriberConfig, Class, Class)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean SyncSubscribersGatekeeper.isSyncSubscriber(SubscriberConfig, Class, Class)"})
   ...
   * Test {@link SyncSubscribersGatekeeper#isSyncSubscriber(SubscriberConfig, Class, Class)}.
   * <ul>
   *   <li>Given {@link JsonParseException#JsonParseException(String)} with {@code Msg}.</li>
