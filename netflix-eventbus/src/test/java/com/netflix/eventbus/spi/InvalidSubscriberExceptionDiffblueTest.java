...
public class InvalidSubscriberExceptionDiffblueTest {
   ...
   * <p>
   * Method under test: {@link InvalidSubscriberException#InvalidSubscriberException(Class, Map)}
   */
  @Test
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Set InvalidSubscriberException.getOffendingMethods()",
