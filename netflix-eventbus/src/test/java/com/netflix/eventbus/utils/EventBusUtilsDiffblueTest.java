...
public class EventBusUtilsDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link EventBusUtils#getQueueSize(SubscriberConfigProvider.SubscriberConfig)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"int EventBusUtils.getQueueSize(SubscriberConfigProvider.SubscriberConfig)"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean EventBusUtils.isAnEventBatch(Object)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link EventBusUtils#getInterestedEventType(Object, Method)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Class EventBusUtils.getInterestedEventType(Object, Method)"})
  public void testGetInterestedEventType_thenThrowIllegalArgumentException() {
    ...
    org.mockito.Mockito.<Class<?>>when(dynamicSubscriber.getEventType()).thenThrow(new IllegalArgumentException("foo"));
   ...
   * </ul>
   * <p>
   * Method under test: {@link EventBusUtils#applyFilters(Object, Set, StatsTimer, String, Logger)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean EventBusUtils.applyFilters(Object, Set, StatsTimer, String, Logger)"})
