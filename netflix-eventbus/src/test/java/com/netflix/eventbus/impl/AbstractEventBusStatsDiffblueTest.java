...
public class AbstractEventBusStatsDiffblueTest {
   ...
   * <p>
   * Method under test: {@link LatencyStats#compute()}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link LatencyStats#getMax()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link LatencyStats#getMean()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link LatencyStats#getMedian()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link LatencyStats#getPercentile_90()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link LatencyStats#getPercentile_99()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link LatencyStats#getPercentile_99_5()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link LatencyStats#getSampleSize()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link LatencyStats#getStddev()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link LatencyStats#LatencyStats(AbstractEventBusStats)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
