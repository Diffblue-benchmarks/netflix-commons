...
public class PairDiffblueTest {
  ...
  @MethodsUnderTest({"void Pair.<init>(Object, Object)", "void Pair.setFirst(Object)", "void Pair.setSecond(Object)"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Object Pair.first()"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Object Pair.second()"})
