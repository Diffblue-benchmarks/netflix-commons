...
public class MeasuredRateDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link MeasuredRate#MeasuredRate(long)} with sampleInterval is forty-two.</li>
   * </ul>
   * <p>
   ...
   * Test {@link MeasuredRate#getCount()}.
   * <ul>
   *   <li>Given {@link MeasuredRate#MeasuredRate(long)} with sampleInterval is minus one.</li>
   * </ul>
   * <p>
   * Method under test: {@link MeasuredRate#getCount()}
   */
