...
public class SimpleEventBusBridgeStatsDiffblueTest {
   ...
   * <p>
   * Method under test: {@link SimpleEventBusBridgeStats#incConsumeErrorCount(Exception)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link SimpleEventBusBridgeStats#getLastConsumeException()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link SimpleEventBusBridgeStats}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
