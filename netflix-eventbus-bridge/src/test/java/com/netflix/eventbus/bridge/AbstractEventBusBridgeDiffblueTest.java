...
public class AbstractEventBusBridgeDiffblueTest {
   ...
   * <p>
   * Method under test: {@link Builder#withAutoStart(Boolean)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link Builder#withEventBus(EventBus)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link Builder#withEventType(Class)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link Builder#withFilter(EventFilter)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * </ul>
   * <p>
   * Method under test: {@link Builder#withStatsSupplier(Supplier)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * </ul>
   * <p>
   * Method under test: {@link Builder#withStats(EventBusBridgeStats)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
