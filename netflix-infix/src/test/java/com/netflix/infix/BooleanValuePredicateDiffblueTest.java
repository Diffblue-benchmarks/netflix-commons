...
public class BooleanValuePredicateDiffblueTest {
  ...
  @MethodsUnderTest({"boolean BooleanValuePredicate.apply(Boolean)"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Boolean BooleanValuePredicate.getValue()", "String BooleanValuePredicate.toString()"})
  ...
  /**
   * Test {@link BooleanValuePredicate#equals(Object)}, and {@link BooleanValuePredicate#hashCode()}.
   * <ul>
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean BooleanValuePredicate.equals(Object)", "int BooleanValuePredicate.hashCode()"})
