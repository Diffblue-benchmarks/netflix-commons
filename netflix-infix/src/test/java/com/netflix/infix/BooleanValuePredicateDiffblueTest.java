...
public class BooleanValuePredicateDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Boolean BooleanValuePredicate.getValue()",
    "String BooleanValuePredicate.toString()"
  })
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean BooleanValuePredicate.equals(Object)",
    "int BooleanValuePredicate.hashCode()"
  })
