...
public class BetweenTreeNodeDiffblueTest {
  ...
  @MethodsUnderTest({"void BetweenTreeNode.<init>(Token)"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void BetweenTreeNode.<init>(BetweenTreeNode)"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Tree BetweenTreeNode.dupNode()"})
