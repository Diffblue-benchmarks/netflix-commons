...
public class FalseValueTreeNodeDiffblueTest {
  ...
  @MethodsUnderTest({"void FalseValueTreeNode.<init>(Token)", "Object FalseValueTreeNode.getValue()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link FalseValueTreeNode#FalseValueTreeNode(FalseValueTreeNode)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
