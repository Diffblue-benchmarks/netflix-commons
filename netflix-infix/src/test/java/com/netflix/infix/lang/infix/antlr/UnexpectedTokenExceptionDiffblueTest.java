...
public class UnexpectedTokenExceptionDiffblueTest {
   ...
   * <p>
   * Method under test: {@link UnexpectedTokenException#UnexpectedTokenException(Tree, String[])}
   */
  @Test
   ...
   * <ul>
   *   <li>Then return {@code Unexpected token null at 0:0. Expected: Expected}.</li>
   * </ul>
   * <p>
