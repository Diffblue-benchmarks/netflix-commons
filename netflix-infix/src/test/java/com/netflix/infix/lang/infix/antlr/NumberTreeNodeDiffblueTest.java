...
public class NumberTreeNodeDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"java.lang.Number NumberTreeNode.getValue()"})
  ...
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"void NumberTreeNode.<init>(Token)"})
  ...
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"void NumberTreeNode.<init>(NumberTreeNode)"})
  ...
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"Tree NumberTreeNode.dupNode()"})
