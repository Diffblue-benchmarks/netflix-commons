...
public class BetweenTimeMillisTreeNodeDiffblueTest {
  ...
  public void testDupNode() {
    ...
    assertSame(t, ((BetweenTimeMillisTreeNode) actualDupNodeResult).getToken());
  }
  ...
  public void testDupNode2() {
    // Arrange and Act
    Tree actualDupNodeResult = (new BetweenTimeMillisTreeNode(mock(Token.class))).dupNode();
   ...
   */
  @Test
  public void testNewBetweenTimeMillisTreeNode2() {
    // Arrange
    ClassicToken t = new ClassicToken(1);
   ...
   */
  @Test
  public void testNewBetweenTimeMillisTreeNode3() {
    // Arrange and Act
    BetweenTimeMillisTreeNode actualBetweenTimeMillisTreeNode = new BetweenTimeMillisTreeNode(
        new BetweenTimeMillisTreeNode(mock(Token.class)));
    ...
    assertEquals(0, actualBetweenTimeMillisTreeNode.getTokenStartIndex());
    assertEquals(0, actualBetweenTimeMillisTreeNode.getTokenStopIndex());
    assertEquals(0, actualBetweenTimeMillisTreeNode.getType());
    assertFalse(actualBetweenTimeMillisTreeNode.isNil());
    assertEquals(EventFilterLexer.EOF, actualBetweenTimeMillisTreeNode.getChildIndex());
  }
}
