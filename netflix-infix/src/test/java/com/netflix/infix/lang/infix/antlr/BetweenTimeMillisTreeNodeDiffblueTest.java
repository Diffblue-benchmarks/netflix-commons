...
public class BetweenTimeMillisTreeNodeDiffblueTest {
   ...
   * <p>
   * Method under test: {@link BetweenTimeMillisTreeNode#BetweenTimeMillisTreeNode(Token)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link BetweenTimeMillisTreeNode#BetweenTimeMillisTreeNode(BetweenTimeMillisTreeNode)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
