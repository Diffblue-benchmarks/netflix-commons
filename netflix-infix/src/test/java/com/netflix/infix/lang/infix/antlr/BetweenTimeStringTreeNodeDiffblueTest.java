...
public class BetweenTimeStringTreeNodeDiffblueTest {
   ...
   * <p>
   * Method under test: {@link BetweenTimeStringTreeNode#BetweenTimeStringTreeNode(Token)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void BetweenTimeStringTreeNode.<init>(Token)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link BetweenTimeStringTreeNode#BetweenTimeStringTreeNode(BetweenTimeStringTreeNode)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void BetweenTimeStringTreeNode.<init>(BetweenTimeStringTreeNode)"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Tree BetweenTimeStringTreeNode.dupNode()"})
