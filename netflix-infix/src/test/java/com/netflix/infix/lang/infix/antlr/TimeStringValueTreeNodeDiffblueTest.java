...
public class TimeStringValueTreeNodeDiffblueTest {
   ...
   * <p>
   * Method under test: {@link TimeStringValueTreeNode#TimeStringValueTreeNode(Token)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link TimeStringValueTreeNode#TimeStringValueTreeNode(TimeStringValueTreeNode)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
