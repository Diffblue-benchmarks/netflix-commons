...
public class TimeStringValueTreeNodeDiffblueTest {
  ...
  public void testDupNode() {
    ...
    assertSame(t, ((TimeStringValueTreeNode) actualDupNodeResult).getToken());
  }
  ...
  public void testDupNode2() {
    // Arrange and Act
    Tree actualDupNodeResult = (new TimeStringValueTreeNode(mock(Token.class))).dupNode();
   ...
   */
  @Test
  public void testNewTimeStringValueTreeNode2() {
    // Arrange
    ClassicToken t = new ClassicToken(1);
   ...
   */
  @Test
  public void testNewTimeStringValueTreeNode3() {
    // Arrange and Act
    TimeStringValueTreeNode actualTimeStringValueTreeNode = new TimeStringValueTreeNode(
        new TimeStringValueTreeNode(mock(Token.class)));
    ...
    assertEquals(0, actualTimeStringValueTreeNode.getTokenStartIndex());
    assertEquals(0, actualTimeStringValueTreeNode.getTokenStopIndex());
    assertEquals(0, actualTimeStringValueTreeNode.getType());
    assertFalse(actualTimeStringValueTreeNode.isNil());
    assertEquals(EventFilterLexer.EOF, actualTimeStringValueTreeNode.getChildIndex());
  }
}
