...
public class RegexValuePredicateDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "MatchPolicy RegexValuePredicate.getMatchPolicy()",
    "String RegexValuePredicate.toString()"
  })
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean RegexValuePredicate.equals(Object)",
    "int RegexValuePredicate.hashCode()"
  })
