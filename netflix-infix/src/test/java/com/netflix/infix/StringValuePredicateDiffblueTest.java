...
public class StringValuePredicateDiffblueTest {
  ...
  @MethodsUnderTest({"void StringValuePredicate.<init>(String)", "String StringValuePredicate.getValue()",
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean StringValuePredicate.equals(Object)", "int StringValuePredicate.hashCode()"})
