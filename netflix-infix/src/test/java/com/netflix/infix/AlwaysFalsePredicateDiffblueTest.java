...
public class AlwaysFalsePredicateDiffblueTest {
   ...
   *
   * <p>Method under test: {@link AlwaysFalsePredicate#apply(Object)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link AlwaysFalsePredicate#toString()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean AlwaysFalsePredicate.equals(Object)",
    "int AlwaysFalsePredicate.hashCode()"
  })
   ...
   * </ul>
   *
   * <p>Method under test: {@link AlwaysFalsePredicate#equals(Object)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
