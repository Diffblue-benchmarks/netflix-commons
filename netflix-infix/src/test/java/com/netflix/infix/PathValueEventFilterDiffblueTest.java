...
public class PathValueEventFilterDiffblueTest {
  ...
  @MethodsUnderTest({"void PathValueEventFilter.<init>(String, ValuePredicate)",
      "ValuePredicate PathValueEventFilter.getPredicate()", "String PathValueEventFilter.getXpath()",
   ...
   * <ul>
   *   <li>Given {@link PathValueEventFilter#PathValueEventFilter(String, ValuePredicate)} with {@code Path} and predicate is {@link NullValuePredicate#INSTANCE}.</li>
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean PathValueEventFilter.equals(Object)", "int PathValueEventFilter.hashCode()"})
