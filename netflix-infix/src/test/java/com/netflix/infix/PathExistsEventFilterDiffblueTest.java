...
public class PathExistsEventFilterDiffblueTest {
  ...
  @MethodsUnderTest({"void PathExistsEventFilter.<init>(String)", "String PathExistsEventFilter.getXpath()",
      "String PathExistsEventFilter.toString()"})
   ...
   * <ul>
   *   <li>Given {@link PathExistsEventFilter#PathExistsEventFilter(String)} with path is {@code 42}.</li>
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean PathExistsEventFilter.apply(Object)"})
   ...
   * Test {@link PathExistsEventFilter#apply(Object)}.
   * <ul>
   *   <li>Given {@link PathExistsEventFilter#PathExistsEventFilter(String)} with {@code Path}.</li>
   *   <li>Then return {@code true}.</li>
   * </ul>
   * <p>
   * Method under test: {@link PathExistsEventFilter#apply(Object)}
  ...
  /**
   * Test {@link PathExistsEventFilter#equals(Object)}, and {@link PathExistsEventFilter#hashCode()}.
   * <ul>
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean PathExistsEventFilter.equals(Object)", "int PathExistsEventFilter.hashCode()"})
