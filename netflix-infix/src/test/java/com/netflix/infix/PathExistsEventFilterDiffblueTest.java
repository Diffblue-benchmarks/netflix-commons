...
public class PathExistsEventFilterDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void PathExistsEventFilter.<init>(String)",
    "String PathExistsEventFilter.getXpath()",
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean PathExistsEventFilter.equals(Object)",
    "int PathExistsEventFilter.hashCode()"
  })
